...
class Estimator
{
  public:
    ...
    std::string reliability_sequence_name = "urban28-pankyo";
    std::string reliability_feature_csv_path =
    "/home/ivlab3/vins_project/results/vins_eval_results/KAIST_urban28_pankyo/reliability_features_vins.csv";
